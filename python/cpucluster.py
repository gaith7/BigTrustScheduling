...
for index,i in J.iterrows():
    ...
    elif i[1] <= 1200 and i[1] > 600:
        cost.append (i[0] / 3600000 * 0.1)
    elif i[1] <= 2000 and i[1] > 1200:
        cost.append (i[0] / 3600000 * 0.2)
    elif i[1] <= 2400 and i[1] > 2000:
...
documents.to_csv('/Users/gaithrjoub/Desktop/pro/cpu_cluster.csv')
...
frames.rename(index=str, columns={1: "CPU"},inplace=True)

print(frames)
frames.to_csv('/Users/gaithrjoub/Desktop/pro/cpuprobx.csv')