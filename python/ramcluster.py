...
R = list((map(float,datagaith['	Memory usage [KB]'])))
# print(R)
...
path1 = "/Users/gaithrjoub/Desktop/generated_time.csv"
Q = pd.read_csv(path1)
Q = pd.DataFrame(Q)
...
for index,i in J.iterrows():
    # and i [2] <= 200
    if i[1] <= 128000:
        cost.append (0.05 * i[0] / 3600000)
    elif i[1] <= 256000 and i[1] > 128000:
        cost.append (0.1 * i[0] / 3600000)
    elif i[1] <= 512000 and i[1] > 256000:
        cost.append (0.2 * i[0] / 3600000)
    elif i[1] <= 1024000 and i[1] > 512000:
        cost.append (0.3 * i[0] / 3600000)
        # if J [1] > 1048576 and  J [2] > 1400 :
    else:
        cost.append (0.4 * i[0] / 3600000)
...
documents.to_csv('/Users/gaithrjoub/Desktop/pro/ram_cluster.csv')
...
frames.rename(index=str, columns={1: "RAM"},inplace=True)

print(frames)
frames.to_csv('//Users/gaithrjoub/Desktop/pro/ramprobx.csv')