...
R = list((map(float,datagaith['	Disk write throughput [KB/s]'])))


# Q = list((map(float,datagaith['Timestamp [ms]'])))
...
#
#     my_randoms.append(random.randrange(180000000,1376314846))
#
# Q=my_randoms
...
#datagaith_CPU=J[1]
#datagaith_CPU_mean=datagaith_CPU.mean()
#datagaith_CPU_std=datagaith_CPU.std()


#print(datagaith_CPU_mean)
#print(datagaith_CPU_std)
#
#lower=abs(datagaith_CPU_mean-datagaith_CPU_std)
#uper=abs(datagaith_CPU_mean+datagaith_CPU_std)
...
#for index, i in datagaith_CPU.iteritems():
    #if i>uper:
    #    uperlist_CPU.append(index)
   # elif i<=uper and i>=lower:
   #     meadianlist_CPU.append(index)
  #  else:
 #       lowerlist_CPU.append(index)
...
for index,i in J.iterrows():
    # and i [2] <= 200
    if i[1] <= 3:
       cost.append ((0.198 * 10) * ((i[0] / 3600000))/30)
    #    and i[2] <= 400 and i[2] > 200
    elif i[1] <= 3 and i[1] > 7:
       cost.append ((0.198 * 32) * ((i[0] / 3600000))/30)
    #     and i[2] <= 800 and i[2] > 400
    elif i[1] <= 15 and i[1] > 7:
        cost.append((0.198 * 64) * ((i[0] / 3600000))/30)
    #      and i[2] <= 1400 and i[2] > 800
    elif i[1] <= 30 and i[1] > 15:
        cost.append((0.198 * 128) * ((i[0] / 3600000))/30)
    #if J [1] > 1048576 and  J [2] > 1400 :
    else:
        cost.append ((0.198 * 256) * ((i[0] / 3600000))/30)
...
# plt.plot(cost1,'r--',cost2,'bs',cost3,'g^',cost4,'y--',cost5)
# plt.ylabel('cost1')
# plt.show()
...
documents.to_csv('/Users/gaithrjoub/Desktop/pro/ds_cluster.csv')
...
#
#
# cost1=pd.DataFrame(cost1)
# cost2=pd.DataFrame(cost2)
# cost3=pd.DataFrame(cost3)
# cost4=pd.DataFrame(cost4)
# cost5=pd.DataFrame(cost5)
...
frames.rename(index=str, columns={1: "DS"},inplace=True)

print(frames)
frames.to_csv('/Users/gaithrjoub/Desktop/pro/dsprobx.csv')